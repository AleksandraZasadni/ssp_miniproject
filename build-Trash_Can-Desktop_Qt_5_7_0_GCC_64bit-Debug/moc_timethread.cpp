...
#include "../Trash_Can/timethread.h"
...
void TimeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TimeThread::sendTime)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void TimeThread::sendTime(QString _t1)
{
