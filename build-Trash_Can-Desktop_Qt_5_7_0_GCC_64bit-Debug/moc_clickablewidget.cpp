...
#include "../Trash_Can/clickablewidget.h"
...
void clickableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (clickableWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&clickableWidget::clicked)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject clickableWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_clickableWidget.data,
      qt_meta_data_clickableWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
